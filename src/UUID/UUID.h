 ...
 * @LastEditors: xixi_
 * @LastEditTime: 2024-11-09 03:27:07
 * @FilePath: /FHMF/src/Modules/xixi/src/UUID/UUID.h
...
#define THIS_ID_LENGHT 19 /* ID长度 */
    ...
    */
     ...
     *
     * @note 调用者需负责释放返回的内存。请勿使用 `printf("%s", XIXI_GetUUID());` 直接打印返回值。
     */
    char *XIXI_GetUUID(void);
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /**
     * @brief 根据时间戳生成ID
     *
